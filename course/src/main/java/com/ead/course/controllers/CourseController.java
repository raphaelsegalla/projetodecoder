...
public class CourseController {
    ...
    public ResponseEntity<Page<CourseModel>> getAllCourses(SpecificationTemplate.CourseSpec spec,
        ...
        if (userId != null) {
            return ResponseEntity.status(HttpStatus.OK).body(courseService.findAll(pageable, SpecificationTemplate.courseUserId(userId).and(spec)));
        }
        return ResponseEntity.status(HttpStatus.OK).body(courseService.findAll(pageable, spec));
    }
